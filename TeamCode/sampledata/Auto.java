...
public class Auto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            moveForwardForTime(1.0);
            strafeRightForTime(1.45);
            moveForwardForTime(1.55);
            strafeRightForTime(0.75);
            moveBackwardForTime(2.7);
            strafeLeftForTime(0.2);
            rotire(0.1);
            moveForwardForTime(2.3);
            strafeRightForTime(0.7);
            moveBackwardForTime(2.6);
            moveForwardForTime(2.4);
            strafeRightForTime(0.75);
            moveBackwardForTime(2.65);
        }
    }
